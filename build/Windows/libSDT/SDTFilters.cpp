...
extern "C" {
	...
	__declspec(dllexport) SDTOnePole *SDTOnePole_new() {
		SDTOnePole *x;
	...
	__declspec(dllexport) void SDTOnePole_free(SDTOnePole *x) {
		free(x);
	}

	__declspec(dllexport) void SDTOnePole_setFeedback(SDTOnePole *x, double f) {
		x->a1 = SDT_fclip(f, -1.0, 1.0);
		x->b0 = 1.0 - fabs(x->a1);
	}

	__declspec(dllexport) void SDTOnePole_lowpass(SDTOnePole *x, double f) {
		double w;
	...
	__declspec(dllexport) void SDTOnePole_highpass(SDTOnePole *x, double f) {
		double w;
	...
	__declspec(dllexport) double SDTOnePole_dsp(SDTOnePole *x, double in) {
	...
	__declspec(dllexport) SDTAllPass *SDTAllPass_new() {
		SDTAllPass *x;
	...
	__declspec(dllexport) void SDTAllPass_free(SDTAllPass *x) {
		free(x);
	}

	__declspec(dllexport) void SDTAllPass_setFeedback(SDTAllPass *x, double f) {
		x->a = SDT_fclip(f, -1.0, 1.0);
	}

	__declspec(dllexport) double SDTAllPass_dsp(SDTAllPass *x, double in) {
	...
	__declspec(dllexport) SDTEnvelope *SDTEnvelope_new() {
		SDTEnvelope *x;
	...
	__declspec(dllexport) void SDTEnvelope_free(SDTEnvelope *x) {
		free(x);
	}

	__declspec(dllexport) void SDTEnvelope_setAttack(SDTEnvelope *x, double a) {
		double w;
	...
	__declspec(dllexport) void SDTEnvelope_setRelease(SDTEnvelope *x, double r) {
		double w;
	...
	__declspec(dllexport) double SDTEnvelope_dsp(SDTEnvelope *x, double in) {
		double x0;
	...
	__declspec(dllexport) SDTTwoPoles *SDTTwoPoles_new() {
		SDTTwoPoles *x;
	...
	__declspec(dllexport) void SDTTwoPoles_free(SDTTwoPoles *x) {
		free(x);
	}

	__declspec(dllexport) void SDTTwoPoles_lowpass(SDTTwoPoles *x, double fc) {
		double d;
	...
	__declspec(dllexport) void SDTTwoPoles_highpass(SDTTwoPoles *x, double fc) {
		double d;
	...
	__declspec(dllexport) void SDTTwoPoles_resonant(SDTTwoPoles *x, double fc, double q) {
		double w, r;
	...
	__declspec(dllexport) double SDTTwoPoles_dsp(SDTTwoPoles *x, double in) {
		double result;
	...
	__declspec(dllexport) SDTBiquad *SDTBiquad_new(int nSections) {
		SDTBiquad *x;
		int i, n;
	...
	__declspec(dllexport) void SDTBiquad_free(SDTBiquad *x) {
		free(x->buf);
		free(x);
	}

	__declspec(dllexport) void SDTBiquad_common(SDTBiquad *x, int i, double fc, double q) {
	...
	__declspec(dllexport) void SDTBiquad_butterworthLP(SDTBiquad *x, double fc) {
		double q;
		int i;
	...
	__declspec(dllexport) void SDTBiquad_butterworthHP(SDTBiquad *x, double fc) {
		double q;
		int i;
	...
	__declspec(dllexport) void SDTBiquad_butterworthAP(SDTBiquad *x, double fc) {
		double q;
		int i;
	...
	__declspec(dllexport) void SDTBiquad_linkwitzRileyLP(SDTBiquad *x, double fc) {
		double q;
		int i, j;
	...
	__declspec(dllexport) void SDTBiquad_linkwitzRileyHP(SDTBiquad *x, double fc) {
		double q;
		int i, j;
	...
	__declspec(dllexport) double SDTBiquad_dsp(SDTBiquad *x, double in) {
		double x0, y0;
		int i, j;
	...
	__declspec(dllexport) SDTAverage *SDTAverage_new(long size) {
		SDTAverage *x;
		long i;
	...
	__declspec(dllexport) void SDTAverage_free(SDTAverage *x) {
		free(x->buf);
		free(x);
	}

	__declspec(dllexport) void SDTAverage_setWindow(SDTAverage *x, unsigned int i) {
		int j, k;
	...
	__declspec(dllexport) double SDTAverage_dsp(SDTAverage *x, double in) {
		x->sum -= x->buf[x->last];
		x->buf[x->curr] = in;
		x->sum += x->buf[x->curr];
	...
	__declspec(dllexport) SDTDelay *SDTDelay_new(long maxDelay) {
		SDTDelay *x;
		long i;
	...
	__declspec(dllexport) void SDTDelay_free(SDTDelay *x) {
	...
	__declspec(dllexport) void SDTDelay_clear(SDTDelay *x) {
		long i;
	...
	__declspec(dllexport) void SDTDelay_setDelay(SDTDelay *x, double f) {
		double d;
	...
	__declspec(dllexport) double SDTDelay_dsp(SDTDelay *x, double in) {
	...
	__declspec(dllexport) SDTComb *SDTComb_new(long maxXDelay, long maxYDelay) {
		SDTComb *x;
	...
	__declspec(dllexport) void SDTComb_free(SDTComb *x) {
		SDTDelay_free(x->xDelay);
		SDTDelay_free(x->yDelay);
		free(x);
	}

	__declspec(dllexport) void SDTComb_setXDelay(SDTComb *x, double f) {
		SDTDelay_setDelay(x->xDelay, f);
	}

	__declspec(dllexport) void SDTComb_setYDelay(SDTComb *x, double f) {
		SDTDelay_setDelay(x->yDelay, f);
	}

	__declspec(dllexport) void SDTComb_setXYDelay(SDTComb *x, double f) {
		SDTDelay_setDelay(x->xDelay, f);
		SDTDelay_setDelay(x->yDelay, f);
	}

	__declspec(dllexport) void SDTComb_setXGain(SDTComb *x, double f) {
		x->xGain = SDT_fclip(f, -1.0, 1.0);
	}

	__declspec(dllexport) void SDTComb_setYGain(SDTComb *x, double f) {
		x->yGain = SDT_fclip(f, -1.0, 1.0);
	}

	__declspec(dllexport) void SDTComb_setXYGain(SDTComb *x, double f) {
		x->xGain = SDT_fclip(f, -1.0, 1.0);
		x->yGain = SDT_fclip(f, -1.0, 1.0);
	}

	__declspec(dllexport) double SDTComb_dsp(SDTComb *x, double in) {
		double xOut, yOut;
	...
	__declspec(dllexport) SDTWaveguide *SDTWaveguide_new(int maxDelay) {
		SDTWaveguide *x;
	...
	__declspec(dllexport) void SDTWaveguide_free(SDTWaveguide *x) {
		SDTDelay_free(x->fwdDelay);
		SDTDelay_free(x->revDelay);
		free(x);
	}

	__declspec(dllexport) double SDTWaveguide_getFwdOut(SDTWaveguide *x) {
		return x->fwdThru;
	}

	__declspec(dllexport) double SDTWaveguide_getRevOut(SDTWaveguide *x) {
		return x->revThru;
	}

	__declspec(dllexport) void SDTWaveguide_setDelay(SDTWaveguide *x, double f) {
		SDTDelay_setDelay(x->fwdDelay, f);
		SDTDelay_setDelay(x->revDelay, f);
	}

	__declspec(dllexport) void SDTWaveguide_setFwdFeedback(SDTWaveguide *x, double f) {
		x->fwdFeedGain = SDT_fclip(f, -1.0, 1.0);
		x->fwdThruGain = 1.0 - fabs(x->fwdFeedGain);
	}

	__declspec(dllexport) void SDTWaveguide_setRevFeedback(SDTWaveguide *x, double f) {
		x->revFeedGain = SDT_fclip(f, -1.0, 1.0);
		x->revThruGain = 1.0 - fabs(x->revFeedGain);
	}

	__declspec(dllexport) void SDTWaveguide_dsp(SDTWaveguide *x, double fwdIn, double revIn) {
