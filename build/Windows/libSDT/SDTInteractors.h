...
extern __declspec(dllexport) void SDTInteractor_setFirstResonator(SDTInteractor *x, SDTResonator *p);

/** @brief Sets the pointer to the second interacting resonator
@param[in] p Pointer to a SDTResonator instance */
extern __declspec(dllexport) void SDTInteractor_setSecondResonator(SDTInteractor *x, SDTResonator *p);
...
extern __declspec(dllexport) void SDTInteractor_setFirstPoint(SDTInteractor *x, long l);
...
extern __declspec(dllexport) void SDTInteractor_setSecondPoint(SDTInteractor *x, long l);

/** @brief Computes a force to apply to the contact points,
based on the resonators' state at the chosen pickups */ 
extern __declspec(dllexport) double SDTInteractor_computeForce(SDTInteractor *x);
...
extern __declspec(dllexport) void SDTInteractor_dsp(SDTInteractor *x, double f0, double v0, double s0,
...
extern __declspec(dllexport) SDTInteractor *SDTImpact_new();

/** @brief Object destructor.
param[in] Pointer to a SDTInteractor instance, configured for the impact case. */
extern __declspec(dllexport) void SDTImpact_free(SDTInteractor *x);

/** @brief Sets the impact stiffness.
@param[in] f Impact stiffness (>> 1) */
extern __declspec(dllexport) void SDTImpact_setStiffness(SDTInteractor *x, double f);

/** @brief Sets the dissipation coefficient.
@param[in] f Dissipation coefficient, positive scalar */
extern __declspec(dllexport) void SDTImpact_setDissipation(SDTInteractor *x, double f);

/** @brief Sets the shape factor.
@param[in] f Shape factor. Must be > 1, with 1.5 = spherical shape. Optimal range [1,4] */
extern __declspec(dllexport) void SDTImpact_setShape(SDTInteractor *x, double f);
...
extern __declspec(dllexport) SDTInteractor *SDTFriction_new();

/** @brief Object destructor.
param[in] Pointer to a SDTInteractor instance, configured for the friction case. */
extern __declspec(dllexport) void SDTFriction_free(SDTInteractor *x);

/** @brief Sets the perpendicular force (pressure) applied to the two sliding resonators.
@param[in] f Normal force, in N */
extern __declspec(dllexport) void SDTFriction_setNormalForce(SDTInteractor *x, double f);

/** @brief Sets the Stribeck velocity.
@param[in] f Stribeck velocity, in m/s */
extern __declspec(dllexport) void SDTFriction_setStribeckVelocity(SDTInteractor *x, double f);

/** @brief Sets the static friction coefficient.
@param[in] f Static friction coefficient [0,1] */
extern __declspec(dllexport) void SDTFriction_setStaticCoefficient(SDTInteractor *x, double f);
...
extern __declspec(dllexport) void SDTFriction_setDynamicCoefficient(SDTInteractor *x, double f);

/** @brief Sets the break away coefficient.
@param[in] f Break away coefficient, positive scalar */
extern __declspec(dllexport) void SDTFriction_setBreakAway(SDTInteractor *x, double f);

/** @brief Sets the contact stiffness.
@param[in] f Contact stiffness, positive scalar */
extern __declspec(dllexport) void SDTFriction_setStiffness(SDTInteractor *x, double f);

/** @brief Sets the dissipation coefficient.
@param[in] f Dissipation coefficient, positive scalar */
extern __declspec(dllexport) void SDTFriction_setDissipation(SDTInteractor *x, double f);

/** @brief Sets the contact viscosity.
@param[in] f Contact viscosity, positive scalar */
extern __declspec(dllexport) void SDTFriction_setViscosity(SDTInteractor *x, double f);

/** @brief Sets the surface roughness.
@param[in] f Surface roughness, positive scalar */
extern __declspec(dllexport) void SDTFriction_setNoisiness(SDTInteractor *x, double f);
