...
extern __declspec(dllexport) SDTPinkNoise *SDTPinkNoise_new(int nOctaves);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTPinkNoise_free(SDTPinkNoise *x);

/** @brief Signal processing routine.
Call this function at sample rate to generate pink noise */
extern __declspec(dllexport) double SDTPinkNoise_dsp(SDTPinkNoise *x);

/** @brief Signal processing routine.
Call this function at sample rate to generate white noise */
extern __declspec(dllexport) double SDT_whiteNoise();
