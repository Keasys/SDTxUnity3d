...
extern __declspec(dllexport) SDTWindFlow *SDTWindFlow_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTWindFlow_free(SDTWindFlow *x);
...
extern __declspec(dllexport) void SDTWindFlow_setFilters(SDTWindFlow *x);

/** @brief Sets the wind speed.
@param[in] x Pointer to a SDTWindFlow instance
@param[in] f Wind speed [0,1] */
__declspec(dllexport) void SDTWindFlow_setWindSpeed(SDTWindFlow *x, double f);
...
extern __declspec(dllexport) double SDTWindFlow_dsp(SDTWindFlow *x);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTWindCavity *SDTWindCavity_new(int maxDelay);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTWindCavity_free(SDTWindCavity *x);

/** @brief Sets the lenght of the cavity.
@param[in] f Length of the cavity, in m */
extern __declspec(dllexport) void SDTWindCavity_setLength(SDTWindCavity *x, double f);

/** @brief Sets the diameter of the cavity.
@param[in] f Diameter of the cavity, in m */
extern __declspec(dllexport) void SDTWindCavity_setDiameter(SDTWindCavity *x, double f);

/** @brief Sets the wind speed.
@param[in] f Wind speed, [0,1] */
extern __declspec(dllexport) void SDTWindCavity_setWindSpeed(SDTWindCavity *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to synthesize wind through a cavity.
@return Computed audio sample */
extern __declspec(dllexport) double SDTWindCavity_dsp(SDTWindCavity *x);
...
typedef __declspec(dllexport) struct SDTWindKarman SDTWindKarman;

/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTWindKarman *SDTWindKarman_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTWindKarman_free(SDTWindKarman *x);

/** @brief Sets the diameter of the object.
@param[in] f Diameter of the object, in m. Works best with very small values (< 0.1) */
extern __declspec(dllexport) void SDTWindKarman_setDiameter(SDTWindKarman *x, double f);

/** @brief Sets the wind speed.
@param[in] f Wind speed, [0,1] */
extern __declspec(dllexport) void SDTWindKarman_setWindSpeed(SDTWindKarman *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to synthesize wind blowing against a thin object.
@return Computed audio sample */
extern __declspec(dllexport) double SDTWindKarman_dsp(SDTWindKarman *x);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTExplosion *SDTExplosion_new(long maxScatter, long maxDelay);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTExplosion_free(SDTExplosion *x);

/** @brief Sets the duration of the initial spike.
@param[in] f Blast time, in s */
extern __declspec(dllexport) void SDTExplosion_setBlastTime(SDTExplosion *x, double f);

/** @brief Sets the duration of the scattering.
@param[in] f Scattering time, in s */
extern __declspec(dllexport) void SDTExplosion_setScatterTime(SDTExplosion *x, double f);

/** @brief Sets the balance between initial spike and successive scattering.
@param[in] f Amount of scattering, [0,1] */
extern __declspec(dllexport) void SDTExplosion_setDispersion(SDTExplosion *x, double f);

/** @brief Sets the distance of the listener from the explosion.
@param[in] f Distance between explosion and listener, in m */
extern __declspec(dllexport) void SDTExplosion_setDistance(SDTExplosion *x, double f);

/** @brief Sets the propagation velocity of the shockwave.
@param[in] f Propagation velocity of the shockwave, in m/s */
extern __declspec(dllexport) void SDTExplosion_setWaveSpeed(SDTExplosion *x, double f);

/** @brief Sets the propagation velocity of the blast wind.
@param[in] f Propagation velocity of the blast wind, in m/s */
extern __declspec(dllexport) void SDTExplosion_setWindSpeed(SDTExplosion *x, double f);
...
extern __declspec(dllexport) void SDTExplosion_update(SDTExplosion *x);

/** @brief Signal processing routine.
Call this function at sample rate to synthesize an explosion sound.
@return Computed audio sample */
extern __declspec(dllexport) void SDTExplosion_dsp(SDTExplosion *x, double *outs);
