...
extern __declspec(dllexport) SDTBubble *SDTBubble_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTBubble_free(SDTBubble *x);

/** @brief Sets the bubble radius.
@param[in] f Bubble radius, in m [0.00015, 0.150] */
extern __declspec(dllexport) void SDTBubble_setRadius(SDTBubble *x, double f);

/** @brief Sets the bubble depth.
@param[in] f Bubble depth [0, 1]. 0 means very deep, 1 means touching the surface. */
extern __declspec(dllexport) void SDTBubble_setDepth(SDTBubble *x, double f);

/** @brief Sets the amount of blooping.
@param[in] f Rise factor, positive scalar. Typical value for bubbles in water = 0.1 */
extern __declspec(dllexport) void SDTBubble_setRiseFactor(SDTBubble *x, double f);

/** @brief Triggers a new bubble */
extern __declspec(dllexport) void SDTBubble_update(SDTBubble *x);

/** @brief Sets bubble amplitude to the maximum instead of computing it from radius and depth. */
extern __declspec(dllexport) void SDTBubble_normAmp(SDTBubble *x);

/** @brief Signal processing routine.
Call this function at sample rate to obtain a bubble sound.
@return Output sample */
extern __declspec(dllexport) double SDTBubble_dsp(SDTBubble *x);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTFluidFlow *SDTFluidFlow_new(int nBubbles);

/** @brief Object destructor.
@param[in] x Poiter to the instance to destroy */
extern __declspec(dllexport) void SDTFluidFlow_free(SDTFluidFlow *x);
...
extern __declspec(dllexport) void SDTFluidFlow_setMinRadius(SDTFluidFlow *x, double f);
...
extern __declspec(dllexport) void SDTFluidFlow_setMaxRadius(SDTFluidFlow *x, double f);
...
extern __declspec(dllexport) void SDTFluidFlow_setExpRadius(SDTFluidFlow *x, double f);

/** @brief Sets the minimum depth value for the bubble population.
@param[in] f Minimum depth value of the generated bubbles, [0, 1] */
extern __declspec(dllexport) void SDTFluidFlow_setMinDepth(SDTFluidFlow *x, double f);

/** @brief Sets the maximum depth value for the bubble population.
@param[in] f Maximum depth value of the generated bubbles, [0, 1] */
extern __declspec(dllexport) void SDTFluidFlow_setMaxDepth(SDTFluidFlow *x, double f);
...
extern __declspec(dllexport) void SDTFluidFlow_setExpDepth(SDTFluidFlow *x, double f);

/** @brief Sets the amount of blooping for the bubble population
@param[in] f Rise factor. Typical value for water = 0.1 */
extern __declspec(dllexport) void SDTFluidFlow_setRiseFactor(SDTFluidFlow *x, double f);

/** @brief Bubbles deeper than this threshold do not rise in frequency
@param[in] f Rise cutoff, [0, 1] */
extern __declspec(dllexport) void SDTFluidFlow_setRiseCutoff(SDTFluidFlow *x, double f);

/** @brief Sets the amount of generated bubbles per second.
@param[in] f Average number of bubbles per second */
extern __declspec(dllexport) void SDTFluidFlow_setAvgRate(SDTFluidFlow *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to obtain a liquid sound.
@return Output sample */
extern __declspec(dllexport) double SDTFluidFlow_dsp(SDTFluidFlow *x);
