...
extern __declspec(dllexport) SDTComplex* SDTComplex_car(double real, double imag);

/** @brief Returns a complex exponential with base e and given phase.
@param[in] phase Phase
@return Complex exponential */
extern __declspec(dllexport) SDTComplex* SDTComplex_exp(double phase);

/** @brief Returns the absolute value (magnitude) of a complex number.
@param[in] a Input value
@return Absolute value of input */
extern __declspec(dllexport) double SDTComplex_abs(SDTComplex* a);

/** @brief Returns the angle (phase) of a complex number.
@param[in] a Input value
@return Angle of input */
extern __declspec(dllexport) double SDTComplex_angle(SDTComplex* a);

/** @brief Returns the complex conjugate of a complex number.
@param[in] a Input value
@return Complex conjugate of input */
extern __declspec(dllexport) SDTComplex* SDTComplex_conj(SDTComplex* a);

/** @brief Returns the sum of two complex numbers.
@param[in] a First operand
@param[in] b Second operand
@return a plus b */
extern __declspec(dllexport) SDTComplex* SDTComplex_add(SDTComplex* a, SDTComplex* b);

/** @brief Returns the difference of two complex numbers.
@param[in] a First operand
@param[in] b Second operand
@return a minus b */
extern __declspec(dllexport) SDTComplex* SDTComplex_sub(SDTComplex* a, SDTComplex* b);

/** @brief Returns the multiplication between two complex numbers.
@param[in] a First operand
@param[in] b Second operand
@return a times b */
extern __declspec(dllexport) SDTComplex* SDTComplex_mult(SDTComplex* a, SDTComplex* b);

/** @brief Returns the division between two complex numbers.
@param[in] a First operand
@param[in] b Second operand
@return a divided by b */
extern __declspec(dllexport) SDTComplex* SDTComplex_div(SDTComplex* a, SDTComplex* b);

/** @brief Returns the sum of a complex number and a real number.
@param[in] a Complex operand
@param[in] b Real operand
@return a plus b */
extern __declspec(dllexport) SDTComplex* SDTComplex_addReal(SDTComplex* a, double b);

/** @brief Returns the difference of a complex number and a real number.
@param[in] a Complex operand
@param[in] b Real operand
@return a minus b */
extern __declspec(dllexport) SDTComplex* SDTComplex_subReal(SDTComplex* a, double b);

/** @brief Returns the difference of a real number and a complex number.
@param[in] a Real operand
@param[in] b Complex operand
@return a minus b */
extern __declspec(dllexport) SDTComplex* SDTComplex_realSub(double a, SDTComplex* b);

/** @brief Returns the multiplication between a complex number and a real number.
@param[in] a Complex operand
@param[in] b Real operand
@return a times b */
extern __declspec(dllexport) SDTComplex* SDTComplex_multReal(SDTComplex* a, double b);

/** @brief Returns the division between a complex number and a real number.
@param[in] a Complex operand
@param[in] b Real operand
@return a divided by b */
extern __declspec(dllexport) SDTComplex* SDTComplex_divReal(SDTComplex* a, double b);

/** @brief Returns the division between a real number and a complex number.
@param[in] a Real operand
@param[in] b Complex operand
@return a divided by b */
extern __declspec(dllexport) SDTComplex* SDTComplex_realDiv(double a, SDTComplex* b);
