...
extern __declspec(dllexport) SDTResonator *SDTResonator_new(unsigned int nModes, unsigned int nPickups);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTResonator_free(SDTResonator *x);
...
extern __declspec(dllexport) double SDTResonator_getPosition(SDTResonator *x, unsigned int pickup);

/** @brief Gets the velocity of the object at a given pickup point.
@param[in] pickup Pickup point
@return Object velocity, in m/s */
extern __declspec(dllexport) double SDTResonator_getVelocity(SDTResonator *x, unsigned int pickup);

/** @brief Gets the number of pickup points
@return Number of pickup points */
extern __declspec(dllexport) int SDTResonator_getNPickups(SDTResonator *x);

/** @brief Sets a modal displacement at a given pickup point
@param[in] pickup Pickup point
@param[in] f Modal displacement, in m */
extern __declspec(dllexport) void SDTResonator_setPosition(SDTResonator *x, unsigned int pickup, double f);

/** @brief Sets a modal velocity at a given pickup point
@param[in] pickup Pickup point
@param[in] f Modal velocity, in m/s */
extern __declspec(dllexport) void SDTResonator_setVelocity(SDTResonator *x, unsigned int pickup, double f);

/** @brief Sets the resonant frequency for a given mode
@param[in] mode Mode number
@param[in] f Modal frequency, in Hz */
extern __declspec(dllexport) void SDTResonator_setFrequency(SDTResonator *x, unsigned int mode, double f);

/** @brief Sets the decay for a given mode
@param[in] mode Mode number
@param[in] f Modal decay, in s. A value of 0 means no decay at all (infinite decay time) */
extern __declspec(dllexport) void SDTResonator_setDecay(SDTResonator *x, unsigned int mode, double f);

/** @brief Sets the weight for a given mode
@param[in] mode Mode number
@param[in] f Modal weight, in Kg */
extern __declspec(dllexport) void SDTResonator_setWeight(SDTResonator *x, unsigned int mode, double f);

/** @brief Sets the pickup gain for a given mode and pickup
@param[in] pickup Pickup number
@param[in] mode Mode number
@param[in] f Pickup gain */
extern __declspec(dllexport) void SDTResonator_setGain(SDTResonator *x, unsigned int pickup, unsigned int mode, double f);
...
extern __declspec(dllexport) void SDTResonator_setFragmentSize(SDTResonator *x, double f);

/** @brief Sets the number of active (actually computed) modes.
@param[in] i Number of active (computed) modes */
extern __declspec(dllexport) void SDTResonator_setActiveModes(SDTResonator *x, unsigned int i);
...
extern __declspec(dllexport) void SDTResonator_applyForce(SDTResonator *x, unsigned int pickup, double f);
...
extern __declspec(dllexport) double SDTResonator_computeEnergy(SDTResonator *x, unsigned int pickup, double f);
...
extern __declspec(dllexport) void SDTResonator_dsp(SDTResonator *x);
