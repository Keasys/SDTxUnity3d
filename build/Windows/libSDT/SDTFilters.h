...
extern __declspec(dllexport) SDTOnePole *SDTOnePole_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTOnePole_free(SDTOnePole *x);

/** @brief Manually sets the alpha coefficient
@param[in] f Weight of the input sample */
extern __declspec(dllexport) void SDTOnePole_setFeedback(SDTOnePole *x, double f);

/** @brief Puts the filter in lowpass mode, at the given cutoff frequency.
@param[in] f Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTOnePole_lowpass(SDTOnePole *x, double f);

/** @brief Puts the filter in highpass mode, at the given cutoff frequency.
@param[in] f Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTOnePole_highpass(SDTOnePole *x, double f);
...
extern __declspec(dllexport) double SDTOnePole_dsp(SDTOnePole *x, double in);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTAllPass *SDTAllPass_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTAllPass_free(SDTAllPass *x);

/** @brief Sets the feedback coefficient.
@param[in] f Weight of the input sample */
extern __declspec(dllexport) void SDTAllPass_setFeedback(SDTAllPass *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to compute the filtered signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTAllPass_dsp(SDTAllPass *x, double in);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTEnvelope *SDTEnvelope_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTEnvelope_free(SDTEnvelope *x);

/** @brief Sets the attack time.
@param[in] a Attack time, in ms */
extern __declspec(dllexport) void SDTEnvelope_setAttack(SDTEnvelope *x, double a);

/** @brief Sets the release time.
@param[in] r Release time, in ms */
extern __declspec(dllexport) void SDTEnvelope_setRelease(SDTEnvelope *x, double r);

/** @brief Signal processing routine.
Call this function at sample rate to compute the filtered signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTEnvelope_dsp(SDTEnvelope *x, double in);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTTwoPoles *SDTTwoPoles_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTTwoPoles_free(SDTTwoPoles *x);

/** @brief Puts the filter in lowpass mode, at the given cutoff frequency.
@param[in] fc Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTTwoPoles_lowpass(SDTTwoPoles *x, double fc);

/** @brief Puts the filter in highpass mode, at the given cutoff frequency.
@param[in] fc Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTTwoPoles_highpass(SDTTwoPoles *x, double fc);
...
extern __declspec(dllexport) void SDTTwoPoles_resonant(SDTTwoPoles *x, double fc, double q);

/** @brief Signal processing routine.
Call this function at sample rate to compute the filtered signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTTwoPoles_dsp(SDTTwoPoles *x, double in);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTBiquad *SDTBiquad_new(int nSections);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTBiquad_free(SDTBiquad *x);

/** @brief Designs a Butterworth lowpass filter, at the given cutoff frequency.
@param[in] fc Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTBiquad_butterworthLP(SDTBiquad *x, double fc);

/** @brief Designs a Butterworth highpass filter, at the given cutoff frequency.
@param[in] fc Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTBiquad_butterworthHP(SDTBiquad *x, double fc);


extern __declspec(dllexport) void SDTBiquad_butterworthAP(SDTBiquad *x, double fc);
...
@param[in] fc Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTBiquad_linkwitzRileyLP(SDTBiquad *x, double fc);

/** @brief Designs the highpass part of a Linkwitz-Riley crossover filter,
    at the given cutoff frequency.
    WARNING: the filter must have an even number of biquad sections!
@param[in] fc Cutoff frequency, in Hz */
extern __declspec(dllexport) void SDTBiquad_linkwitzRileyHP(SDTBiquad *x, double fc);

/** @brief Signal processing routine.
Call this function at sample rate to compute the filtered signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTBiquad_dsp(SDTBiquad *x, double in);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTAverage *SDTAverage_new(long size);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern  __declspec(dllexport) void SDTAverage_free(SDTAverage *x);

/** @brief Sets the averaging window.
@param[in] size Moving average window size [1,bufferSize] */
extern __declspec(dllexport) void SDTAverage_setWindow(SDTAverage *x, unsigned int i);

/** @brief Signal processing routine.
Call this function at sample rate to compute the filtered signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTAverage_dsp(SDTAverage *x, double in);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTDelay *SDTDelay_new(long maxDelay);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTDelay_free(SDTDelay *x);

/** @brief Clears the buffer, therefore silencing the delayed signal. */
extern __declspec(dllexport) void SDTDelay_clear(SDTDelay *x);
...
extern __declspec(dllexport) void SDTDelay_setDelay(SDTDelay *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to output the delayed signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTDelay_dsp(SDTDelay *x, double in);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTComb *SDTComb_new(long maxXDelay, long maxYDelay);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTComb_free(SDTComb *x);

/** @brief Sets the delay time for the feed forward section.
@param[in] f Feed forward delay time, in samples */
extern __declspec(dllexport) void SDTComb_setXDelay(SDTComb *x, double f);

/** @brief Sets the delay time for the feedback section.
@param[in] f Feedback delay time, in samples */
extern __declspec(dllexport) void SDTComb_setYDelay(SDTComb *x, double f);

/** @brief Sets the delay time for both sections.
@param[in] f Delay time, in samples */
extern __declspec(dllexport) void SDTComb_setXYDelay(SDTComb *x, double f);

/** @brief Sets the gain for the feed forward section.
@param[in] f Feed forward gain [0,1] */
extern __declspec(dllexport) void SDTComb_setXGain(SDTComb *x, double f);

/** @brief Sets the gain for the feedback section.
@param[in] f Feedback gain [0,1] */
extern __declspec(dllexport) void SDTComb_setYGain(SDTComb *x, double f);

/** @brief Sets the gain for both sections.
@param[in] f Gain [0,1] */
extern __declspec(dllexport) void SDTComb_setXYGain(SDTComb *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to output the filtered signal.
@param[in] in Input sample
@return Output sample */
extern __declspec(dllexport) double SDTComb_dsp(SDTComb *x, double in);
...
@return Pointer to the new instance */
extern __declspec(dllexport) SDTWaveguide *SDTWaveguide_new(int maxDelay);

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTWaveguide_free(SDTWaveguide *x);

/** @brief Reads the output signal coming from the right side of the waveguide.
@return Output sample */
extern __declspec(dllexport) double SDTWaveguide_getFwdOut(SDTWaveguide *x);

/** @brief Reads the output signal coming from the left side of the waveguide.
@return Output sample */
extern __declspec(dllexport) double SDTWaveguide_getRevOut(SDTWaveguide *x);

/** @brief Sets the length of the waveguide, in samples.
@param[in] f Delay time, in samples */
extern __declspec(dllexport) void SDTWaveguide_setDelay(SDTWaveguide *x, double f);
...
@param[in] f Feedback gain [0,1] */
extern __declspec(dllexport) void SDTWaveguide_setFwdFeedback(SDTWaveguide *x, double f);
...
is the output on the same side.
@param[in] f Feedback gain [0,1] */
extern __declspec(dllexport) void SDTWaveguide_setRevFeedback(SDTWaveguide *x, double f);

/** @brief Sets the frequency damping on the right side.
@param[in] f High frequency damping [0,1] */
extern __declspec(dllexport) void SDTWaveguide_setFwdDamping(SDTWaveguide *x, double f);

/** @brief Sets the frequency damping on the left side.
@param[in] f High frequency damping [0,1] */
extern __declspec(dllexport) void SDTWaveguide_setRevDamping(SDTWaveguide *x, double f);
...
extern __declspec(dllexport) void SDTWaveguide_dsp(SDTWaveguide *x, double fwdIn, double revIn);
