...
extern __declspec(dllexport) void SDT_setSampleRate(double sampleRate);
...
extern __declspec(dllexport) unsigned int SDT_argMax(double *x, unsigned int n, double *maxOut);
...
extern __declspec(dllexport) unsigned int SDT_argMin(double *x, unsigned int n, double *minOut);

/** @brief Returns the arithmetic mean of an array of values
@param[in] x Pointer to the data array
@param[in] n Length of the data array
@return Arithmetic mean of the array */
extern __declspec(dllexport) double SDT_average(double *x, unsigned int n);
...
extern __declspec(dllexport) unsigned int SDT_bitReverse(unsigned int u, unsigned int bits);
...
extern __declspec(dllexport) void SDT_blackman(double *sig, int n);
...
extern __declspec(dllexport) long SDT_clip(long x, long min, long max);
...
extern __declspec(dllexport) double SDT_expRand(double lambda);
...
extern __declspec(dllexport) double SDT_fclip(double x, double min, double max);
...
extern __declspec(dllexport) double SDT_frand();
...
extern __declspec(dllexport) void SDT_gaussian1D(double *x, double sigma, int n);
...
extern __declspec(dllexport) int SDT_isHole(double *x, unsigned int i, unsigned int radius);
...
extern __declspec(dllexport) int SDT_isPeak(double *x, unsigned int i, unsigned int radius);
...
extern __declspec(dllexport) double SDT_kinetic(double mass, double velocity);

/** @brief Returns the maximum value in an array of data.
@param[in] x Pointer to the data array
@param[in] n Length of the data array
@return Maximum value in the array */
extern __declspec(dllexport) double SDT_max(double *x, unsigned int n);

/** @brief Returns the minimum value in an array of data.
@param[in] x Pointer to the data array
@param[in] n Length of the data array
@return Minimum value in the array */
extern __declspec(dllexport) double SDT_min(double *x, unsigned int n);

/** @brief Returns the smallest power of 2 greater or equal than u.
@param[in] u Input value
@return Smallest power of 2 greater or equal than u */
extern __declspec(dllexport) unsigned int SDT_nextPow2(unsigned int u);
...
extern __declspec(dllexport) double SDT_rank(double *x, int n, int k);

/** @brief Removes the global average from samples in a window.
@param[in,out] sig window to remove the average from
@param[in] n window size */
extern __declspec(dllexport) void SDT_removeDC(double *sig, int n);
...
@param[in] n buffer size */
extern __declspec(dllexport) int SDT_roi(double *sig, int *peaks, int *bounds, int d, int n);
...
extern __declspec(dllexport) double SDT_samplesInAir(double length);
...
extern __declspec(dllexport) double SDT_scale(double x, double srcMin, double srcMax,
...
@return Signum of x */
extern __declspec(dllexport) int SDT_signum(double x);
...
@param[in] n window size */
extern __declspec(dllexport) void SDT_sinc(double *sig, double w, int n);
...
extern __declspec(dllexport) double SDT_truePeakPos(double *sig, int peak);
...
extern __declspec(dllexport) double SDT_truePeakValue(double *sig, int peak);
...
extern __declspec(dllexport) double SDT_weightedAverage(double *values, double *weights, unsigned int n);
/** @brief Wraps a phase in the range -pi/pi.
Wraps a phase in the range -pi/pi.
@param[x] unwrapped phase
return wrapped phase */
extern __declspec(dllexport) double SDT_wrap(double x);

/** @brief Fills a buffer with zeros.
Fills a buffer with zeros.
@param[in,out] sig pointer to the buffer
@param[in] n buffer size */
extern __declspec(dllexport) void SDT_zeros(double *sig, int n);
