...
extern __declspec(dllexport) SDTBouncing *SDTBouncing_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTBouncing_free(SDTBouncing *x);

/** @brief Sets the coefficient of restitution.
@param[in] f Coefficient of restitution of the bouncing process */
extern __declspec(dllexport) void SDTBouncing_setRestitution(SDTBouncing *x, double f);

/** @brief Sets the initial height of the falling object.
@param[in] f Object height, in m. */
extern __declspec(dllexport) void SDTBouncing_setHeight(SDTBouncing *x, double f);
...
extern __declspec(dllexport) void SDTBouncing_setIrregularity(SDTBouncing *x, double f);

/** @brief Resets the bouncing process, restoring its initial energy */
extern __declspec(dllexport) void SDTBouncing_reset(SDTBouncing *x);
...
extern __declspec(dllexport) double SDTBouncing_dsp(SDTBouncing *x);
...
extern __declspec(dllexport) int SDTBouncing_hasFinished(SDTBouncing *x);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTBreaking *SDTBreaking_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTBreaking_free(SDTBreaking *x);

/** @brief Sets the total energy stored in the object.
@param[in] f Total stored energy consumed by the micro impacts, in N */
extern __declspec(dllexport) void SDTBreaking_setStoredEnergy(SDTBreaking *x, double f);
...
extern __declspec(dllexport) void SDTBreaking_setCrushingEnergy(SDTBreaking *x, double f);

/** @brief Sets the event density of the crumpling process.
@param[in] f Event density [0, 1] */
extern __declspec(dllexport) void SDTBreaking_setGranularity(SDTBreaking *x, double f);

/** @brief Sets the amount of progressive fragmentation of the object during the process.
@param[in] f Object fragmentation [0, 1] */
extern __declspec(dllexport) void SDTBreaking_setFragmentation(SDTBreaking *x, double f);
...
extern __declspec(dllexport) void SDTBreaking_reset(SDTBreaking *x);
...
@param[out] outs Pointer to the output array: impact energy and fragment size */
extern __declspec(dllexport) void SDTBreaking_dsp(SDTBreaking *x, double *outs);
                                    
/** @brief Checks if the breaking process is finished, i.e. if the remaining energy is 0.
@return 1 (true) if the remaining energy is <= 0, 0 (false) otherwise. */
extern __declspec(dllexport) int SDTBreaking_hasFinished(SDTBreaking *x);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTCrumpling *SDTCrumpling_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTCrumpling_free(SDTCrumpling *x);

/** @brief Sets the crushing energy.
@param[in] f Average energy of the micro impacts, compared to the global energy of the process [0, 1] */
extern __declspec(dllexport) void SDTCrumpling_setCrushingEnergy(SDTCrumpling *x, double f);

/** @brief Sets the event density of the crumpling process.
@param[in] f Event density [0, 1] */
extern __declspec(dllexport) void SDTCrumpling_setGranularity(SDTCrumpling *x, double f);

/** @brief Sets the amount of fragmentation of the object during the process.
@param[in] f Object fragmentation [0, 1] */
extern __declspec(dllexport) void SDTCrumpling_setFragmentation(SDTCrumpling *x, double f);
...
@param[out] outs Pointer to the output array: impact energy and fragment size */
extern __declspec(dllexport) void SDTCrumpling_dsp(SDTCrumpling *x, double *outs);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTRolling *SDTRolling_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTRolling_free(SDTRolling *x);
...
extern __declspec(dllexport) void SDTRolling_setGrain(SDTRolling *x, double f);
...
extern __declspec(dllexport) void SDTRolling_setDepth(SDTRolling *x, double f);
...
extern __declspec(dllexport) void SDTRolling_setMass(SDTRolling *x, double f);

/** @brief Sets the rolling velocity.
@param[in] f Rolling velocity */
extern __declspec(dllexport) void SDTRolling_setVelocity(SDTRolling *x, double f);
...
extern __declspec(dllexport) double SDTRolling_dsp(SDTRolling *x, double in);
...
/** @brief Object constructor.
@return Pointer to the new instance */
extern __declspec(dllexport) SDTScraping *SDTScraping_new();

/** @brief Object destructor.
@param[in] x Pointer to the instance to destroy */
extern __declspec(dllexport) void SDTScraping_free(SDTScraping *x);
...
@param[in] f Surface grain [0, 1] */
extern __declspec(dllexport) void SDTScraping_setGrain(SDTScraping *x, double f);
...
extern __declspec(dllexport) void SDTScraping_setForce(SDTScraping *x, double f);

/** @brief Sets the scraping velocity.
@param[in] f Probe velocity */
extern __declspec(dllexport) void SDTScraping_setVelocity(SDTScraping *x, double f);

/** @brief Signal processing routine.
Call this function at sample rate to compute the force acting on the scraped surface.
@param[in] in Surface profile, as an audio signal
@return Normal force on the resonator */
extern __declspec(dllexport) double SDTScraping_dsp(SDTScraping *x, double in);
